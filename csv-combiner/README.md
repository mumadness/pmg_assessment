...
## Input & Output
<strong>Original instruction:</strong> We will run your code as follows
```
$ ./csv-combiner.php ./fixtures/accessories.csv ./fixtures/clothing.csv > combined.csv
```
<strong>I completed the challenge in Python, please run the following command </strong>
```
python csv-combiner.py fixtures/accessories.csv fixtures/clothing.csv fixtures/household_cleaners.csv > combined.csv
```
My code works with 2 or more csv files with the same format
